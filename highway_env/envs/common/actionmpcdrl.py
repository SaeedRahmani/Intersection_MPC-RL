...
class ContinuousAction(ActionType):
    ...
    def __init__(self,
                 ...
                 lateral: bool = True,
                 speed_control: bool = True, # Added speed control parameter
    ...
    def act(self, action: np.ndarray) -> None:
        ...
        if self.speed_control:
            desired_speed = utils.lmap(action[2], [-1, 1], self.speed_range)
            self.controlled_vehicle.target_speed = desired_speed  # Set the target speed directly
            
        self.controlled_vehicle.act(control_action)
